...
public class BrushMarshallingEmitterTests
{
    ...
    public void Emits_the_native_brush_vtable_and_the_chrome_slots()
    {
        ...
        Assert.Contains("#define I_AVN_BORDER_ABI_VERSION 11", header, StringComparison.Ordinal);
        Assert.Contains("#define I_AVN_PANEL_ABI_VERSION 10", header, StringComparison.Ordinal);
        Assert.Contains("#define I_AVN_TEXT_BLOCK_ABI_VERSION 13", header, StringComparison.Ordinal);
        Assert.Contains("#define I_AVN_CONTROL_ABI_VERSION 7", header, StringComparison.Ordinal);
        Assert.Contains("#define I_AVN_DECORATOR_ABI_VERSION 9", header, StringComparison.Ordinal);
        Assert.Contains(
