...
fn wrap_panel_carries_spacing_orientation_and_item_size() {
    for expected in [
        ...
        "#define I_AVN_WRAP_PANEL_ABI_VERSION 7",
    ] {
...
fn wave_c_interfaces_publish_abi_version_one_and_nothing_else_moved() {
    for expected in [
        "#define I_AVN_WRAP_PANEL_ABI_VERSION 7",
        "#define I_AVN_UNIFORM_GRID_ABI_VERSION 7",
        "#define I_AVN_RELATIVE_PANEL_ABI_VERSION 7",
        "#define I_AVN_VIEWBOX_ABI_VERSION 7",
        "#define I_AVN_FLEX_PANEL_ABI_VERSION 7",
        "#define I_AVN_THUMB_ABI_VERSION 9",
        "#define I_AVN_GRID_SPLITTER_ABI_VERSION 9",
