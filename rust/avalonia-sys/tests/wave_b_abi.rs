...
fn wave_b_interfaces_publish_abi_version_one_and_nothing_else_moved() {
    for expected in [
        ...
        "#define I_AVN_MENU_BASE_ABI_VERSION 11",
        "#define I_AVN_MENU_ABI_VERSION 11",
        "#define I_AVN_MENU_ITEM_ABI_VERSION 14",
        "#define I_AVN_HEADERED_SELECTING_ITEMS_CONTROL_ABI_VERSION 11",
        "#define I_AVN_SPLIT_VIEW_ABI_VERSION 8",
        ...
        "#define I_AVN_HEADERED_ITEMS_CONTROL_ABI_VERSION 11",
        "#define I_AVN_TREE_VIEW_ABI_VERSION 11",
    ] {
        assert!(HEADER.contains(expected), "header is missing `{expected}`");
    }
}
...
fn wave_b_iids_are_fresh_and_distinct_from_every_shipped_one() {
    ...
    for (name, expected, current) in [
        ...
        (
            "IAvnItemsControl",
            "9C4451EB-FDF9-589F-BA9E-C722C0E422DD",
            I_AVN_ITEMS_CONTROL_IID,
        ),
        (
            "IAvnSelectingItemsControl",
            "BC8883C2-BD4A-522A-935A-CDF40BDD9E15",
