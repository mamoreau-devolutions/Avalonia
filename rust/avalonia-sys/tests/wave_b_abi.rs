...
fn wave_b_interfaces_publish_abi_version_one_and_nothing_else_moved() {
    for expected in [
        ...
        "#define I_AVN_MENU_BASE_ABI_VERSION 10",
        "#define I_AVN_MENU_ABI_VERSION 10",
        "#define I_AVN_MENU_ITEM_ABI_VERSION 13",
        "#define I_AVN_HEADERED_SELECTING_ITEMS_CONTROL_ABI_VERSION 10",
        "#define I_AVN_SPLIT_VIEW_ABI_VERSION 7",
        "#define I_AVN_DATE_PICKER_ABI_VERSION 8",
        "#define I_AVN_TIME_PICKER_ABI_VERSION 8",
        ...
        "#define I_AVN_HEADERED_ITEMS_CONTROL_ABI_VERSION 10",
        "#define I_AVN_TREE_VIEW_ABI_VERSION 10",
    ] {
        assert!(HEADER.contains(expected), "header is missing `{expected}`");
    }
}
...
fn wave_b_iids_are_fresh_and_distinct_from_every_shipped_one() {
    ...
    for (name, expected, current) in [
        ...
        (
            "IAvnItemsControl",
            "367D7D0F-3313-57D6-B48D-C74EBE851C4A",
            I_AVN_ITEMS_CONTROL_IID,
        ),
        (
            "IAvnSelectingItemsControl",
            "63F01962-6D43-59DA-904F-13F9AC95965C",
