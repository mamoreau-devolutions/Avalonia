...
fn widened_interfaces_publish_abi_version_five() {
    for expected in [
        ...
        "#define I_AVN_LIST_BOX_ABI_VERSION 10",
        "#define I_AVN_LIST_BOX_ITEM_ABI_VERSION 9",
        "#define I_AVN_COMBO_BOX_ABI_VERSION 11",
        "#define I_AVN_COMBO_BOX_ITEM_ABI_VERSION 9",
        "#define I_AVN_SCROLL_VIEWER_ABI_VERSION 10",
        "#define I_AVN_WINDOW_ABI_VERSION 12",
...
fn widened_interfaces_republish_under_fresh_iids() {
    ...
    for (name, expected, current) in [
        ...
        (
            "IAvnListBox",
            "BD3D61E3-BF1D-5696-8D16-0240ADBF549F",
            I_AVN_LIST_BOX_IID,
        ),
        (
            "IAvnComboBox",
            "B364B155-4DC9-571E-B361-BC86ACD96F8C",
            I_AVN_COMBO_BOX_IID,
        ),
        (
            "IAvnWindow",
            "A519486C-94FF-5C16-B3D0-1E9C25CE4A30",
            I_AVN_WINDOW_IID,
        ),
    ] {
