...
public static class ComSourceEmitter
{
    ...
    public static string EmitCommand(ProjectionIr ir)
    {
        ...
        sb.AppendLine("{");
        sb.AppendLine("    [PreserveSig]");
        sb.AppendLine("    int Execute();");
        sb.AppendLine();
        sb.AppendLine("    [PreserveSig]");
        sb.AppendLine("    int CanExecute(out int value);");
        sb.AppendLine();
        sb.AppendLine("    [PreserveSig]");
        ...
        sb.AppendLine("    {");
        sb.AppendLine("        _value.Execute(null);");
        sb.AppendLine("        return global::Avalonia.Host.HResults.S_OK;");
        sb.AppendLine("    }");
        sb.AppendLine();
        sb.AppendLine("    public int CanExecute(out int value)");
        sb.AppendLine("    {");
        sb.AppendLine("        value = _value.CanExecute(null) ? 1 : 0;");
        sb.AppendLine("        return global::Avalonia.Host.HResults.S_OK;");
        sb.AppendLine("    }");
        sb.AppendLine();
        ...
        sb.AppendLine("    }");
        sb.AppendLine();
        sb.AppendLine("    private sealed class CommandAdapter : global::System.Windows.Input.ICommand");
        sb.AppendLine("    {");
        sb.AppendLine($"        private readonly {interfaceName} _inner;");
        sb.AppendLine("        public CommandAdapter(" + interfaceName + " inner) => _inner = inner;");
        ...
        sb.AppendLine("        {");
        sb.AppendLine("            var hr = _inner.CanExecute(out var value);");
        sb.AppendLine("            if (hr < 0)");
        sb.AppendLine("                global::System.Runtime.InteropServices.Marshal.ThrowExceptionForHR(hr);");
        ...
        sb.AppendLine("        {");
        sb.AppendLine("            var hr = _inner.Execute();");
        sb.AppendLine("            if (hr < 0)");
        sb.AppendLine("                global::System.Runtime.InteropServices.Marshal.ThrowExceptionForHR(hr);");
        sb.AppendLine("        }");
        sb.AppendLine("    }");
