...
public static class AvaloniaProjectionProfiles
{
    public static ProjectionPolicy ObjectModelKernel { get; } = new()
    {
        ...
        AbiVersions = new Dictionary<string, int>(StringComparer.Ordinal)
        {
            ...
            ["Avalonia.Host.Com.IAvnButton"] = 7,
            ["Avalonia.Host.Com.IAvnToggleButton"] = 7,
            ["Avalonia.Host.Com.IAvnCheckBox"] = 7,
            ["Avalonia.Host.Com.IAvnRadioButton"] = 7,
            ["Avalonia.Host.Com.IAvnToggleSwitch"] = 7,
            ["Avalonia.Host.Com.IAvnListBox"] = 7,
            ["Avalonia.Host.Com.IAvnComboBox"] = 8,
            ...
            ["Avalonia.Host.Com.IAvnHeaderedItemsControl"] = 3,
            ["Avalonia.Host.Com.IAvnHeaderedSelectingItemsControl"] = 3,
            ...
            ["Avalonia.Host.Com.IAvnSplitButton"] = 3,
            ["Avalonia.Host.Com.IAvnSplitView"] = 2,
            ["Avalonia.Host.Com.IAvnTabControl"] = 3,
            ...
            ["Avalonia.Host.Com.IAvnTreeView"] = 3,
            ["Avalonia.Host.Com.IAvnTreeViewItem"] = 3,
        ...
        IncludeMembers = new Dictionary<string, IReadOnlyList<string>>(StringComparer.Ordinal)
        {
            ...
            ["Avalonia.Controls.ItemsControl"] = ["ItemCount", "ScrollIntoView"],
            ["Avalonia.Controls.Primitives.HeaderedItemsControl"] = ["Header"],
            ["Avalonia.Controls.Primitives.SelectingItemsControl"] =
                ["AutoScrollToSelectedItem", "IsTextSearchEnabled", "WrapSelection", "BeginInit", "EndInit"],
