...
public static class AvaloniaProjectionProfiles
{
    public static ProjectionPolicy ObjectModelKernel { get; } = new()
    {
        ...
        AbiVersions = new Dictionary<string, int>(StringComparer.Ordinal)
        {
            ...
            ["Avalonia.Host.Com.IAvnDecorator"] = 5,
            ...
            ["Avalonia.Host.Com.IAvnBorder"] = 7,
            ["Avalonia.Host.Com.IAvnTableViewColumn"] = 3,
            ["Avalonia.Host.Com.IAvnPanel"] = 6,
            ["Avalonia.Host.Com.IAvnCanvas"] = 6,
            ["Avalonia.Host.Com.IAvnDockPanel"] = 6,
            ["Avalonia.Host.Com.IAvnStackPanel"] = 7,
            ...
            ["Avalonia.Host.Com.IAvnItemsControl"] = 8,
            ["Avalonia.Host.Com.IAvnSelectingItemsControl"] = 8,
            ["Avalonia.Host.Com.IAvnTextBox"] = 11,
            ["Avalonia.Host.Com.IAvnRangeBase"] = 7,
            ["Avalonia.Host.Com.IAvnSlider"] = 7,
            ["Avalonia.Host.Com.IAvnProgressBar"] = 8,
            ["Avalonia.Host.Com.IAvnContentControl"] = 8,
            ["Avalonia.Host.Com.IAvnHeaderedContentControl"] = 8,
            ["Avalonia.Host.Com.IAvnExpander"] = 8,
            ["Avalonia.Host.Com.IAvnButton"] = 11,
            ["Avalonia.Host.Com.IAvnToggleButton"] = 11,
            ["Avalonia.Host.Com.IAvnCheckBox"] = 11,
            ["Avalonia.Host.Com.IAvnRadioButton"] = 11,
            ["Avalonia.Host.Com.IAvnToggleSwitch"] = 11,
            ["Avalonia.Host.Com.IAvnListBox"] = 9,
            ["Avalonia.Host.Com.IAvnComboBox"] = 10,
            ["Avalonia.Host.Com.IAvnListBoxItem"] = 8,
            ["Avalonia.Host.Com.IAvnComboBoxItem"] = 8,
            ["Avalonia.Host.Com.IAvnScrollViewer"] = 10,
            ["Avalonia.Host.Com.IAvnWindow"] = 11,
            ["Avalonia.Host.Com.IAvnGrid"] = 7,
            // Previously version-1 templated types inherit the TemplatedControl bump.
            ["Avalonia.Host.Com.IAvnAutoCompleteBox"] = 6,
            ["Avalonia.Host.Com.IAvnButtonSpinner"] = 4,
            ["Avalonia.Host.Com.IAvnCalendar"] = 5,
            ["Avalonia.Host.Com.IAvnCalendarDatePicker"] = 5,
            ["Avalonia.Host.Com.IAvnCarousel"] = 6,
            ["Avalonia.Host.Com.IAvnCommandBar"] = 6,
            ["Avalonia.Host.Com.IAvnCommand"] = 2,
            ["Avalonia.Host.Com.IAvnCommandBarButton"] = 6,
            ["Avalonia.Host.Com.IAvnCommandBarSeparator"] = 4,
            ["Avalonia.Host.Com.IAvnCommandBarToggleButton"] = 6,
            ["Avalonia.Host.Com.IAvnContextMenu"] = 9,
            ...
            ["Avalonia.Host.Com.IAvnHeaderedItemsControl"] = 5,
            ["Avalonia.Host.Com.IAvnHeaderedSelectingItemsControl"] = 5,
            ["Avalonia.Host.Com.IAvnHyperlinkButton"] = 6,
            ["Avalonia.Host.Com.IAvnIconElement"] = 4,
            ["Avalonia.Host.Com.IAvnLabel"] = 5,
            ["Avalonia.Host.Com.IAvnMaskedTextBox"] = 8,
            ["Avalonia.Host.Com.IAvnMenu"] = 5,
            ["Avalonia.Host.Com.IAvnMenuBase"] = 5,
            ["Avalonia.Host.Com.IAvnMenuItem"] = 8,
            ["Avalonia.Host.Com.IAvnNotificationCard"] = 5,
            ["Avalonia.Host.Com.IAvnNumericUpDown"] = 5,
            ["Avalonia.Host.Com.IAvnPathIcon"] = 4,
            ["Avalonia.Host.Com.IAvnPipsPager"] = 5,
            ["Avalonia.Host.Com.IAvnRefreshContainer"] = 5,
            ["Avalonia.Host.Com.IAvnRepeatButton"] = 6,
            ["Avalonia.Host.Com.IAvnSeparator"] = 4,
            ["Avalonia.Host.Com.IAvnSpinner"] = 4,
            ["Avalonia.Host.Com.IAvnSplitButton"] = 7,
            ["Avalonia.Host.Com.IAvnSplitView"] = 4,
            ["Avalonia.Host.Com.IAvnTabControl"] = 5,
            ["Avalonia.Host.Com.IAvnTabItem"] = 4,
            ["Avalonia.Host.Com.IAvnTableView"] = 5,
            ["Avalonia.Host.Com.IAvnTableViewCell"] = 4,
            ...
            ["Avalonia.Host.Com.IAvnTreeView"] = 5,
            ["Avalonia.Host.Com.IAvnTreeViewItem"] = 5,
            ...
            ["Avalonia.Host.Com.IAvnImage"] = 3,
            ["Avalonia.Host.Com.IAvnWrapPanel"] = 3,
            ["Avalonia.Host.Com.IAvnUniformGrid"] = 3,
            ["Avalonia.Host.Com.IAvnRelativePanel"] = 3,
            ["Avalonia.Host.Com.IAvnViewbox"] = 3,
            ["Avalonia.Host.Com.IAvnFlexPanel"] = 3,
            ["Avalonia.Host.Com.IAvnShape"] = 3,
            ["Avalonia.Host.Com.IAvnRectangle"] = 3,
            ["Avalonia.Host.Com.IAvnEllipse"] = 3,
            ["Avalonia.Host.Com.IAvnLine"] = 3,
            ["Avalonia.Host.Com.IAvnPath"] = 3,
            ["Avalonia.Host.Com.IAvnPolygon"] = 3,
            ["Avalonia.Host.Com.IAvnPolyline"] = 3,
            ["Avalonia.Host.Com.IAvnArc"] = 3,
            ["Avalonia.Host.Com.IAvnSector"] = 3,
            ["Avalonia.Host.Com.IAvnLayoutTransformControl"] = 3,
            ["Avalonia.Host.Com.IAvnThemeVariantScope"] = 3,
        ...
        IncludeMembers = new Dictionary<string, IReadOnlyList<string>>(StringComparer.Ordinal)
        {
            ...
            [
                ...
                "AllowTapRangeSelection", "DisplayModeChanged",
            ],
            ["Avalonia.Controls.CalendarDatePicker"] =
            [
                "SelectedDate", "DisplayDate", "DisplayDateStart", "DisplayDateEnd",
