...
public static class AvaloniaProjectionProfiles
{
    public static ProjectionPolicy ObjectModelKernel { get; } = new()
    {
        ...
        AbiVersions = new Dictionary<string, int>(StringComparer.Ordinal)
        {
            ...
            ["Avalonia.Host.Com.IAvnStyledElement"] = 4,
            ["Avalonia.Host.Com.IAvnControl"] = 5,
            ["Avalonia.Host.Com.IAvnDecorator"] = 6,
            ...
            ["Avalonia.Host.Com.IAvnBorder"] = 8,
            ["Avalonia.Host.Com.IAvnTableViewColumn"] = 4,
            ["Avalonia.Host.Com.IAvnPanel"] = 7,
            ["Avalonia.Host.Com.IAvnCanvas"] = 7,
            ["Avalonia.Host.Com.IAvnDockPanel"] = 7,
            ["Avalonia.Host.Com.IAvnStackPanel"] = 8,
            ...
            ["Avalonia.Host.Com.IAvnTextBlock"] = 10,
            ["Avalonia.Host.Com.IAvnSelectableTextBlock"] = 7,
            ["Avalonia.Host.Com.IAvnTemplatedControl"] = 8,
            ["Avalonia.Host.Com.IAvnItemsControl"] = 11,
            ["Avalonia.Host.Com.IAvnSelectingItemsControl"] = 11,
            ["Avalonia.Host.Com.IAvnTextBox"] = 13,
            ["Avalonia.Host.Com.IAvnRangeBase"] = 8,
            ["Avalonia.Host.Com.IAvnSlider"] = 8,
            ["Avalonia.Host.Com.IAvnProgressBar"] = 9,
            ["Avalonia.Host.Com.IAvnContentControl"] = 9,
            ["Avalonia.Host.Com.IAvnHeaderedContentControl"] = 9,
            ["Avalonia.Host.Com.IAvnExpander"] = 9,
            ["Avalonia.Host.Com.IAvnButton"] = 12,
            ["Avalonia.Host.Com.IAvnToggleButton"] = 12,
            ["Avalonia.Host.Com.IAvnCheckBox"] = 12,
            ["Avalonia.Host.Com.IAvnRadioButton"] = 12,
            ["Avalonia.Host.Com.IAvnToggleSwitch"] = 12,
            ["Avalonia.Host.Com.IAvnListBox"] = 12,
            ["Avalonia.Host.Com.IAvnComboBox"] = 13,
            ["Avalonia.Host.Com.IAvnListBoxItem"] = 11,
            ["Avalonia.Host.Com.IAvnComboBoxItem"] = 11,
            ["Avalonia.Host.Com.IAvnScrollViewer"] = 11,
            ["Avalonia.Host.Com.IAvnWindow"] = 14,
            ["Avalonia.Host.Com.IAvnGrid"] = 8,
            // Previously version-1 templated types inherit the TemplatedControl bump.
            ["Avalonia.Host.Com.IAvnAutoCompleteBox"] = 9,
            ["Avalonia.Host.Com.IAvnButtonSpinner"] = 5,
            ["Avalonia.Host.Com.IAvnCalendar"] = 7,
            ["Avalonia.Host.Com.IAvnCalendarDatePicker"] = 6,
            ["Avalonia.Host.Com.IAvnCarousel"] = 9,
            ["Avalonia.Host.Com.IAvnCommandBar"] = 7,
            ["Avalonia.Host.Com.IAvnCommand"] = 2,
            ["Avalonia.Host.Com.IAvnCommandBarButton"] = 7,
            ["Avalonia.Host.Com.IAvnCommandBarSeparator"] = 5,
            ["Avalonia.Host.Com.IAvnCommandBarToggleButton"] = 7,
            ["Avalonia.Host.Com.IAvnContextMenu"] = 10,
            ...
            ["Avalonia.Host.Com.IAvnDatePicker"] = 6,
            ["Avalonia.Host.Com.IAvnDropDownButton"] = 7,
            ["Avalonia.Host.Com.IAvnGridSplitter"] = 6,
            ["Avalonia.Host.Com.IAvnGroupBox"] = 5,
            ["Avalonia.Host.Com.IAvnHeaderedItemsControl"] = 8,
            ["Avalonia.Host.Com.IAvnHeaderedSelectingItemsControl"] = 8,
            ["Avalonia.Host.Com.IAvnHyperlinkButton"] = 7,
            ["Avalonia.Host.Com.IAvnIconElement"] = 5,
            ["Avalonia.Host.Com.IAvnLabel"] = 6,
            ["Avalonia.Host.Com.IAvnMaskedTextBox"] = 10,
            ["Avalonia.Host.Com.IAvnMenu"] = 8,
            ["Avalonia.Host.Com.IAvnMenuBase"] = 8,
            ["Avalonia.Host.Com.IAvnMenuItem"] = 11,
            ["Avalonia.Host.Com.IAvnNotificationCard"] = 6,
            ["Avalonia.Host.Com.IAvnNumericUpDown"] = 6,
            ["Avalonia.Host.Com.IAvnPathIcon"] = 5,
            ["Avalonia.Host.Com.IAvnPipsPager"] = 6,
            ["Avalonia.Host.Com.IAvnRefreshContainer"] = 6,
            ["Avalonia.Host.Com.IAvnRepeatButton"] = 7,
            ["Avalonia.Host.Com.IAvnSeparator"] = 5,
            ["Avalonia.Host.Com.IAvnSpinner"] = 5,
            ["Avalonia.Host.Com.IAvnSplitButton"] = 8,
            ["Avalonia.Host.Com.IAvnSplitView"] = 5,
            ["Avalonia.Host.Com.IAvnTabControl"] = 8,
            ["Avalonia.Host.Com.IAvnTabItem"] = 7,
            ["Avalonia.Host.Com.IAvnTableView"] = 8,
            ["Avalonia.Host.Com.IAvnTableViewCell"] = 7,
            ["Avalonia.Host.Com.IAvnTableViewRow"] = 5,
            ["Avalonia.Host.Com.IAvnThumb"] = 6,
            ["Avalonia.Host.Com.IAvnTimePicker"] = 6,
            ["Avalonia.Host.Com.IAvnToggleSplitButton"] = 8,
            ["Avalonia.Host.Com.IAvnToolTip"] = 5,
            ["Avalonia.Host.Com.IAvnTransitioningContentControl"] = 5,
            ["Avalonia.Host.Com.IAvnTreeView"] = 8,
            ["Avalonia.Host.Com.IAvnTreeViewItem"] = 8,
            ["Avalonia.Host.Com.IAvnUserControl"] = 5,
            ["Avalonia.Host.Com.IAvnWindowNotificationManager"] = 6,
            ...
            ["Avalonia.Host.Com.IAvnImage"] = 4,
            ["Avalonia.Host.Com.IAvnWrapPanel"] = 4,
            ["Avalonia.Host.Com.IAvnUniformGrid"] = 4,
            ["Avalonia.Host.Com.IAvnRelativePanel"] = 4,
            ["Avalonia.Host.Com.IAvnViewbox"] = 4,
            ["Avalonia.Host.Com.IAvnFlexPanel"] = 4,
            ["Avalonia.Host.Com.IAvnShape"] = 4,
            ["Avalonia.Host.Com.IAvnRectangle"] = 4,
            ["Avalonia.Host.Com.IAvnEllipse"] = 4,
            ["Avalonia.Host.Com.IAvnLine"] = 4,
            ["Avalonia.Host.Com.IAvnPath"] = 4,
            ["Avalonia.Host.Com.IAvnPolygon"] = 4,
            ["Avalonia.Host.Com.IAvnPolyline"] = 4,
            ["Avalonia.Host.Com.IAvnArc"] = 4,
            ["Avalonia.Host.Com.IAvnSector"] = 4,
            ["Avalonia.Host.Com.IAvnLayoutTransformControl"] = 4,
            ["Avalonia.Host.Com.IAvnThemeVariantScope"] = 4,
        ...
        {
            ["Avalonia.AvaloniaObject"] = [],
            ["Avalonia.StyledElement"] = ["Classes", "Name", "DataContextChanged"],
            ["Avalonia.Controls.Control"] =
            [
            ...
            ["Avalonia.Controls.TabControl"] =
                ["TabStripPlacement", "HorizontalContentAlignment", "VerticalContentAlignment", "SelectedContent", "ContentTemplate"],
