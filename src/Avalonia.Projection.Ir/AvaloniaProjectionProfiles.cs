...
public static class AvaloniaProjectionProfiles
{
    public static ProjectionPolicy ObjectModelKernel { get; } = new()
    {
        ...
        AbiVersions = new Dictionary<string, int>(StringComparer.Ordinal)
        {
            ...
            ["Avalonia.Host.Com.IAvnDecorator"] = 7,
            ...
            ["Avalonia.Host.Com.IAvnBorder"] = 9,
            ["Avalonia.Host.Com.IAvnTableViewColumn"] = 5,
            ["Avalonia.Host.Com.IAvnPanel"] = 8,
            ["Avalonia.Host.Com.IAvnCanvas"] = 8,
            ["Avalonia.Host.Com.IAvnDockPanel"] = 8,
            ["Avalonia.Host.Com.IAvnStackPanel"] = 9,
            ...
            ["Avalonia.Host.Com.IAvnTextBlock"] = 11,
            ["Avalonia.Host.Com.IAvnSelectableTextBlock"] = 8,
            ["Avalonia.Host.Com.IAvnTemplatedControl"] = 9,
            ["Avalonia.Host.Com.IAvnItemsControl"] = 12,
            ["Avalonia.Host.Com.IAvnSelectingItemsControl"] = 12,
            ["Avalonia.Host.Com.IAvnTextBox"] = 14,
            ["Avalonia.Host.Com.IAvnRangeBase"] = 9,
            ["Avalonia.Host.Com.IAvnSlider"] = 9,
            ["Avalonia.Host.Com.IAvnProgressBar"] = 10,
            ["Avalonia.Host.Com.IAvnContentControl"] = 10,
            ["Avalonia.Host.Com.IAvnHeaderedContentControl"] = 10,
            ["Avalonia.Host.Com.IAvnExpander"] = 10,
            ["Avalonia.Host.Com.IAvnButton"] = 13,
            ["Avalonia.Host.Com.IAvnToggleButton"] = 13,
            ["Avalonia.Host.Com.IAvnCheckBox"] = 13,
            ["Avalonia.Host.Com.IAvnRadioButton"] = 13,
            ["Avalonia.Host.Com.IAvnToggleSwitch"] = 13,
            ["Avalonia.Host.Com.IAvnListBox"] = 13,
            ["Avalonia.Host.Com.IAvnComboBox"] = 14,
            ...
            ["Avalonia.Host.Com.IAvnButtonSpinner"] = 6,
            ["Avalonia.Host.Com.IAvnCalendar"] = 8,
            ["Avalonia.Host.Com.IAvnCalendarDatePicker"] = 7,
            ["Avalonia.Host.Com.IAvnCarousel"] = 10,
            ["Avalonia.Host.Com.IAvnCommandBar"] = 8,
            ["Avalonia.Host.Com.IAvnCommand"] = 2,
            ["Avalonia.Host.Com.IAvnCommandBarButton"] = 8,
            ["Avalonia.Host.Com.IAvnCommandBarSeparator"] = 6,
            ["Avalonia.Host.Com.IAvnCommandBarToggleButton"] = 8,
            ["Avalonia.Host.Com.IAvnContextMenu"] = 11,
            ...
            ["Avalonia.Host.Com.IAvnDatePicker"] = 7,
            ["Avalonia.Host.Com.IAvnDropDownButton"] = 8,
            ["Avalonia.Host.Com.IAvnGridSplitter"] = 7,
            ["Avalonia.Host.Com.IAvnGroupBox"] = 6,
            ["Avalonia.Host.Com.IAvnHeaderedItemsControl"] = 9,
            ["Avalonia.Host.Com.IAvnHeaderedSelectingItemsControl"] = 9,
            ["Avalonia.Host.Com.IAvnHyperlinkButton"] = 8,
            ["Avalonia.Host.Com.IAvnIconElement"] = 6,
            ["Avalonia.Host.Com.IAvnLabel"] = 7,
            ["Avalonia.Host.Com.IAvnMaskedTextBox"] = 11,
            ["Avalonia.Host.Com.IAvnMenu"] = 9,
            ["Avalonia.Host.Com.IAvnMenuBase"] = 9,
            ["Avalonia.Host.Com.IAvnMenuItem"] = 12,
            ["Avalonia.Host.Com.IAvnNotificationCard"] = 7,
            ["Avalonia.Host.Com.IAvnNumericUpDown"] = 7,
            ["Avalonia.Host.Com.IAvnPathIcon"] = 6,
            ["Avalonia.Host.Com.IAvnPipsPager"] = 7,
            ["Avalonia.Host.Com.IAvnRefreshContainer"] = 7,
            ["Avalonia.Host.Com.IAvnRepeatButton"] = 8,
            ["Avalonia.Host.Com.IAvnSeparator"] = 6,
            ["Avalonia.Host.Com.IAvnSpinner"] = 6,
            ["Avalonia.Host.Com.IAvnSplitButton"] = 9,
            ["Avalonia.Host.Com.IAvnSplitView"] = 6,
            ["Avalonia.Host.Com.IAvnTabControl"] = 9,
            ["Avalonia.Host.Com.IAvnTabItem"] = 8,
            ["Avalonia.Host.Com.IAvnTableView"] = 9,
            ["Avalonia.Host.Com.IAvnTableViewCell"] = 8,
            ["Avalonia.Host.Com.IAvnTableViewRow"] = 6,
            ["Avalonia.Host.Com.IAvnThumb"] = 7,
            ["Avalonia.Host.Com.IAvnTimePicker"] = 7,
            ["Avalonia.Host.Com.IAvnToggleSplitButton"] = 9,
            ["Avalonia.Host.Com.IAvnToolTip"] = 6,
            ["Avalonia.Host.Com.IAvnTransitioningContentControl"] = 6,
            ["Avalonia.Host.Com.IAvnTreeView"] = 9,
            ["Avalonia.Host.Com.IAvnTreeViewItem"] = 9,
            ["Avalonia.Host.Com.IAvnUserControl"] = 6,
            ["Avalonia.Host.Com.IAvnWindowNotificationManager"] = 7,
            ...
            ["Avalonia.Host.Com.IAvnImage"] = 5,
            ["Avalonia.Host.Com.IAvnWrapPanel"] = 5,
            ["Avalonia.Host.Com.IAvnUniformGrid"] = 5,
            ["Avalonia.Host.Com.IAvnRelativePanel"] = 5,
            ["Avalonia.Host.Com.IAvnViewbox"] = 5,
            ["Avalonia.Host.Com.IAvnFlexPanel"] = 5,
            ["Avalonia.Host.Com.IAvnShape"] = 5,
            ["Avalonia.Host.Com.IAvnRectangle"] = 5,
            ["Avalonia.Host.Com.IAvnEllipse"] = 5,
            ["Avalonia.Host.Com.IAvnLine"] = 5,
            ["Avalonia.Host.Com.IAvnPath"] = 5,
            ["Avalonia.Host.Com.IAvnPolygon"] = 5,
            ["Avalonia.Host.Com.IAvnPolyline"] = 5,
            ["Avalonia.Host.Com.IAvnArc"] = 5,
            ["Avalonia.Host.Com.IAvnSector"] = 5,
            ["Avalonia.Host.Com.IAvnLayoutTransformControl"] = 5,
            ["Avalonia.Host.Com.IAvnThemeVariantScope"] = 5,
