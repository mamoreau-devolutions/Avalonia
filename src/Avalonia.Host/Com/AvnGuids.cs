...
internal static class AvnGuids
{
    ...
    public const string IAvnApplication = "6B2E8F10-4C91-4E3A-9A77-1F0C2B3A4D22";
    ...
    public const string IAvnRustViewModel = "6B2E8F10-4C91-4E3A-9A77-1F0C2B3A4D20";
    public const string IAvnRustVmSink = "6B2E8F10-4C91-4E3A-9A77-1F0C2B3A4D21";
}
