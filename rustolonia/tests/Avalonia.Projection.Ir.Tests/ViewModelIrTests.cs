...
public class ViewModelIrTests
{
    ...
    {
        var path = Path.Combine(FindRepositoryRoot(), "rustolonia", "rust", "view-model.ir.json");
    ...
    {
        var ir = ViewModelIr.FromJson(File.ReadAllText(Path.Combine(FindRepositoryRoot(), "rustolonia", "rust", "view-model.ir.json")));
