...
function Invoke-ConsumerPackage {
    ...
    $hostProject = Join-Path $ProducerRootPath 'rustolonia' 'host' 'Avalonia.Host.csproj'
    $projectionTool = Join-Path $ProducerRootPath 'rustolonia' 'projection' 'Avalonia.ViewModelProjection.Tool' 'Avalonia.ViewModelProjection.Tool.csproj'
