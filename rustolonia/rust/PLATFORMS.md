...
```bash
pwsh ./rustolonia/rust/build.ps1
```
...
AVN_DOTNET_ARTIFACTS="$HOME/.cache/avalonia-rustolonia/rust/dotnet-linux-x64" \
CARGO_TARGET_DIR="$HOME/.cache/avalonia-rustolonia/rust/cargo-linux-x64" \
pwsh ./rustolonia/rust/build.ps1
```
